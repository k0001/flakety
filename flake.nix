{
  ...
  inputs = {
    ...
    attoparsec-time = {
      url = "github:nikita-volkov/attoparsec-time/7c97d3667249a76946d8792b269935245e8301da";
      flake = false;
    };
    ...
    stripeapi = {
      url = "github:Haskell-OpenAPI-Code-Generator/Stripe-Haskell-Library/b98f455f710c42bf8821a8c3d4e2c2aed7ff7a69";
      flake = false;
    };

    dani-servant-lucid2 = {
      url = "github:danidiaz/dani-servant-lucid2/3fefaa24f7a38bcd385a0489167dc0d96e56db2e";
      flake = false;
    };
    ...
    esqueleto = {
      url = "github:bitemyapp/esqueleto/30a5e80736391e2aa45094f681d4bd329aa16707";
      flake = false;
    };

    headed-megaparsec = {
      url = "github:nikita-volkov/headed-megaparsec/3f4ef3d9ac30a1112cdc6cedd635bb01a9bb94a4";
      flake = false;
    };

    postgresql-syntax = {
      url = "github:nikita-volkov/postgresql-syntax/7cae094d542df6b2b370c6f98e08dc33fcb7004d";
      flake = false;
    };

    haskell-src-meta = {
      url = "github:haskell-party/haskell-src-meta/0b924b8bc4e0cf1aa254cd424d4107aa6d1bf4d7";
      flake = false;
    };

    hasql = {
      url = "github:nikita-volkov/hasql/2334d8d686ee037721be89ed54506407e15ecde7";
      flake = false;
    };

    hasql-interpolate = {
      url = "github:awkward-squad/hasql-interpolate/e0f6ad326e320dbfd4eaf3339969a08e2e7555d5";
      flake = false;
    };

    hasql-th = {
      url = "github:nikita-volkov/hasql-th/2dbba60bc67645de4d04c8e7f5403e83bb742abf";
      flake = false;
    };

    hasql-transaction = {
      url = "github:nikita-volkov/hasql-transaction/57a6ff13fbf83172b07ba72771c73a91faf81ab4";
      flake = false;
    };

    hasql-pool = {
      url = "github:nikita-volkov/hasql-pool/e7400b9983f153b792974ba5818a672743cdadab";
      flake = false;
    };

    smtp-mail = {
      url = "github:MasterWordServices/smtp-mail/4c724c80814ab1da7c37256a6c10e04c88b9af95";
      flake = false;
    };
    ...
    odd-jobs = {
      url = "github:saurabhnanda/odd-jobs/411d5d0aaeeb96d4b72d0a434b9d2b53c88c2eae";
      flake = false;
    };
    ...
    streaming-utils = {
      url = "github:k0001/streaming-utils/b7acc4dd0bf4ed6fb16fd4f4999bec24dfabceb3";
      flake = false;
    };
